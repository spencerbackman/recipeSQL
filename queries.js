...
recipeRouter.get('/:id', (req, res) => {
    ...
    pool.query('SELECT ingredientsToRecipes.ing_id, ingredientsToRecipes.rec_id, ingredientsToRecipes.quantity, ingredientsToRecipes.quantity_unit, ingredients.name FROM ingredientsToRecipes JOIN ingredients ON ingredientsToRecipes.ing_id = ingredients.ing_id WHERE ingredientsToRecipes.rec_id = $1', [id])
      .then(results => {
...
recipeRouter.post('/', (req, res) => {
  ...
  pool.query('INSERT INTO recipes (name, by, description) VALUES ($1, $2, $3) RETURNING id', [name, by, description])
    .then(res => {
